...
from geometry_msgs.msg import Point, Twist, Vector3, Quaternion, PoseStamped 
...
class GoToGoal(Node):
    ...
    def __init__(self):
        ...
        self.count = 0 # initialize the goal counter as 1st checkpoint
        ...
        # create publiher for the PoseStamped
    ...
    def odom_callback(self, data):
        ...
        if self.count == 0:
            ...
            local_checkpoint_vec = transformation_matrix.I @ self.waypoint_global_loc[1,:].reshape(-1,1)
            local_checkpoint_dist_x = local_checkpoint_vec[0]
            local_checkpoint_dist_y = local_checkpoint_vec[1]
            # desired_angle = np.pi#90 degrees to the left
        elif self.count == 2:
            local_checkpoint_vec = transformation_matrix.I @ self.waypoint_global_loc[2,:].reshape(-1,1)
            local_checkpoint_dist_x = local_checkpoint_vec[0]
            local_checkpoint_dist_y = local_checkpoint_vec[1]
        ...
        distance_error_x  = abs(local_checkpoint_dist_x)
